...
<div id="posts-right-container">

    <div id="post-right" style="position:relative">

        <a href="javascript:" class="navigation-href float-right" id="notifications-href" style="margin-top:0px;margin-bottom:10px;">N<span id="notifications-count">0</span></a>

        <span id="express-it" class="information left-float yella" style="color:#000 !important;font-family:Roboto-Light !important;display:inline-block;vertical-align:bottom;margin-top:19px;">Write something...</span>

        <br class="clear"/>

        <form modelAttribute="post" method="post" id="share-form" enctype="multipart/form-data">
            <textarea placeholder="Informer, a licky boom boom down" id="voice" name="content"></textarea>
        </form>
        ...
        <div id="actions-container" class="float-right">
            ...
            <div id="image-upload-post-container" class="file-upload-container">
                <form id="image-upload-form">
                    <a href="javascript:" class="button beauty-light small upload-button" id="image-button">Images</a>
...
<%--        <p class="tiny" style="color:#787878">Click on content within a post to edit.</p>--%>

    </div>

    <div id="posts-fellows-fems-outer-container" style="margin-top:4px;display:none;float:right;width:inherit;text-align:left;">
...
{{#.}}
    <div class="notification">
        ...
        {{/invite}}
        {{#invite}}
            <a href="javascript:" class="invite-ref" data-id="${sessionScope.account.id}">{{name}} invited you to connect.</a>
        {{/invite}}
    </div>
{{/.}}
</script>
