...
<script type="text/paperscript" canvas="pond">
    ...
    var hm = new Path('M175.73 52.26L285 238.28L69.26 239.9L175.73 52.26Z');
    ...
    function onFrame(event) {
        for (var i = 0, l = boids.length; i < l; i++) {
            if (groupTogether) {
                var length = ((i + event.count / 30) % l) / l * hm.length;
                var point = hm.getPointAt(length);
                if (point)
