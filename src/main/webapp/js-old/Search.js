...
var Search = function(context){
   ...
   var searchMusicPlayer = new Audio()
    ...
    sessionStorage.getItem("amadeus-search") ? searchBox.value = sessionStorage.getItem("oa-search") : searchBox.value = ""
   ...
   function renderSearchResults(request){
        ...
        if(data.accounts && data.accounts.length > 0){
            ...
            renderMustache(searchResultsTemplate, searchResultsRowsContainer, data.accounts).then(function(){
                ...
                sessionStorage.setItem("amadeus-current", "search")
                sessionStorage.setItem("amadeus-search", searchBox.value)
