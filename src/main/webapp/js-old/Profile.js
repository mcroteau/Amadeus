...
var Profile = function(context){
    ...
    function addEditImageEvents(){
        ...
        imageInputsArr.forEach(function(imageInput, index){
            ...
            imageInput.addEventListener("change", function(event){
                ...
                web.publish(uri, imageForm).then(refreshProfile).then(clearForm)
            })
        })
    }
    ...
    function addDeleteImageEvents() {
        ...
        deleteInputsArr.forEach(function(deleteInput, index) {
            deleteInput.addEventListener("click", function(event){
                ...
                web.publish(uri, deleteForm).then(refreshProfile).then(function(){
    ...
    function performUpdate(id){
        ...
        web.publish(uri, editForm).then(refreshProfile).catch(error)
    }
    ...
    function renderProfile(id){
        return function(request){
            ...
            renderMustache(profileTemplate, profileContainer, data.profile).then(function(){
                sessionStorage.setItem("amadeus-current", "profile")
                sessionStorage.setItem("amadeus-params", JSON.stringify([id]))
