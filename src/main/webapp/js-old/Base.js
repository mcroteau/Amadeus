...
var posts = new Posts("/o")
var profile = new Profile("/o")
var search = new Search("/o")
var friendInvites = new Invites("/o")
...
function showAboutPage(){
    ...
    sessionStorage.setItem("amadeus-current", "about")
...
function showDonatePage(){
    ...
    sessionStorage.setItem("amadeus-current", "donate")
    pageProcessing.style.display = "none"
...
function updateGlobalNotificationsCount(data){
    ...
    baseNotificationsCount.innerHTML = data.messagesCount
...
var paramsArr = []
var currentPage = sessionStorage.getItem("amadeus-current")
var params = sessionStorage.getItem("amadeus-params")
var searchParams = sessionStorage.getItem("amadeus-search")
